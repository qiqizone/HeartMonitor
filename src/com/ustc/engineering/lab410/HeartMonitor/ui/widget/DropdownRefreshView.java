...
public class DropdownRefreshView extends LinearLayout {
...
//	private boolean mLock;
	...
	private  AnimationDrawable mHeaderLoadingCircle;
...
//	private String mLastUpdateTime;
	...
	public DropdownRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
...
/*		mHeaderUpdateTextView = (TextView) mHeaderView
		...
		mHeaderLoadingCircle = (AnimationDrawable) (mHeaderProgressBar
				.getBackground());
		// header layout
	...
	private void addFooterView() {
		...
		mFooterLoadingCircle = (AnimationDrawable) (mFooterProgressBar.getBackground());
		// footer layout
...
//		}
	...
	private boolean isRefreshViewScroll(int deltaY) {
		...
		if (mAdapterView != null) {
			...
			} else if (deltaY < 0 && Math.abs(deltaY)>3) {
		...
		if (mScrollView != null) {
			...
			if (deltaY > 0&& Math.abs(deltaY)>3 && mScrollView.getScrollY() == 0) {
				mPullState = PULL_DOWN_STATE;
				return true;
			} else if (deltaY < 0&& Math.abs(deltaY)>3
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.drawable.icon_refresh_down);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
		mHeaderProgressBar.setVisibility(View.GONE);
		mHeaderView.post(new Runnable() {
			public void run() {
				mHeaderLoadingCircle.stop();
			}
		});
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.drawable.icon_refresh_up);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
		mFooterProgressBar.setVisibility(View.GONE);
		mFooterView.post(new Runnable() {
			public void run() {
				mFooterLoadingCircle.stop();
			}
		});
		// mHeaderUpdateTextView.setText("");
		mFooterState = PULL_TO_REFRESH;
...
//	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(DropdownRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(DropdownRefreshView view);
	}
}
